...
/**
 * This is the item provider adapter for a {@link forms.entityModeling.Table} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TableItemProvider extends RelationshipPageElementItemProvider {
	/**
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(EntityModelingPackage.Literals.TABLE__COLUMNS);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Table.class)) {
			case EntityModelingPackage.TABLE__COLUMNS:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(EntityModelingPackage.Literals.TABLE__COLUMNS,
				 EntityModelingFactory.eINSTANCE.createColumn()));
	}
