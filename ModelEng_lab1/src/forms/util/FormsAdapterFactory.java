...
public class FormsAdapterFactory extends AdapterFactoryImpl {
	...
	protected FormsSwitch<Adapter> modelSwitch =
		new FormsSwitch<Adapter>() {
			@Override
			public Adapter caseEFML_model(EFML_model object) {
				return createEFML_modelAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link forms.EFML_model <em>EFML model</em>}'.
	 * <!-- begin-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createEFML_modelAdapter() {
		return null;
	}
