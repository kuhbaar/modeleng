		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getNamedElementAccess().getGroup_3(), "rule__NamedElement__Group_3__0");
					...
					put(grammarAccess.getNamedElementAccess().getNameAssignment_3_1(), "rule__NamedElement__NameAssignment_3_1");
					put(grammarAccess.getEntityAccess().getNameAssignment_1(), "rule__Entity__NameAssignment_1");
					put(grammarAccess.getEntityAccess().getSuperTypeAssignment_2_1(), "rule__Entity__SuperTypeAssignment_2_1");
					put(grammarAccess.getEntityAccess().getIdAssignment_4_1(), "rule__Entity__IdAssignment_4_1");
					...
					put(grammarAccess.getRelationshipAccess().getLowerBoundAssignment_4_1(), "rule__Relationship__LowerBoundAssignment_4_1");
					put(grammarAccess.getRelationshipAccess().getUpperBoundAssignment_4_3(), "rule__Relationship__UpperBoundAssignment_4_3");
					put(grammarAccess.getRelationshipAccess().getOppositeAssignment_5_1(), "rule__Relationship__OppositeAssignment_5_1");
