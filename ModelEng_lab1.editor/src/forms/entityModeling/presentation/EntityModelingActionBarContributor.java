...
/**
 * This is the action bar contributor for the EntityModeling model editor.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class EntityModelingActionBarContributor
	 ...
	 * @generated
	 */
	public EntityModelingActionBarContributor() {
	...
	public void contributeToToolBar(IToolBarManager toolBarManager) {
		toolBarManager.add(new Separator("entitymodeling-settings"));
		toolBarManager.add(new Separator("entitymodeling-additions"));
	}
	...
	public void contributeToMenu(IMenuManager menuManager) {
		...
		IMenuManager submenuManager = new MenuManager(FormsEditorPlugin.INSTANCE.getString("_UI_EntityModelingEditor_menu"), "forms.entityModelingMenuID");
